####### Uttar Pradesh
data_UP<-read.csv("D:\\RIJOY\\UP_CAP_DIST.csv")
a_UP<-data_UP$CAP
b_UP<-data_UP$DIST
...
####### Andhra Pradesh
data_AP<-read.csv("D:\\RIJOY\\AP_CAP_DIST.csv")
a_AP<-data_AP$CAP
b_AP<-data_AP$DIST
# F test to compare two variances
var.test(a_AP,b_AP)
...
####### Maharashtra
data_MH<-read.csv("D:\\RIJOY\\MAHA_CAP_DIST.csv")
a_MH<-data_MH$CAP
b_MH<-data_MH$DIST
# F test to compare two variances
var.test(a_MH,b_MH)
...
####### Tamilnadu
data_TN<-read.csv("D:\\RIJOY\\TN_CAP_DIST.csv")
a_TN<-data_TN$CAP
b_TN<-data_TN$DIST
# F test to compare two variances
var.test(a_TN,b_TN)
...
####### Madhya Pradesh
data_MP<-read.csv("D:\\RIJOY\\MP_CAP_DIST.csv")
a_MP<-data_MP$CAP
b_MP<-data_MP$DIST
# F test to compare two variances
var.test(a_MP,b_MP)
